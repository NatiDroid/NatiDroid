...
class TranslationUnit(ClangObject):
    ...
    def get_includes(self, max_depth=None):
        """
...
def register_functions(lib, ignore_errors):
    ...
    # use older libclang binding, must close the lib version check, you can edit it in the class variable
    print('===================================')
    print('compatibility_check = True -> False')
    print('===================================')
